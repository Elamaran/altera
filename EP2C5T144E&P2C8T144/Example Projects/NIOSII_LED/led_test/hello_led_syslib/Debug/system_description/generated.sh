...
#
# Generated: 2009-12-31 19:17:31.265
...
ptf=D:\project\led_test\mcu.ptf
...
if test -f /cygdrive/d/altera/80/nios2eds/components/altera_hal/build/os.sh ; then
   . /cygdrive/d/altera/80/nios2eds/components/altera_hal/build/os.sh
fi
